    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                User user = await _userHelper.AddUserAsync(model, imageId, Common.Enums.UserType.User);
                if (user == null)
                {
                ...
                //autologon del usuario al ingresar a la aplicacion
                ...
                Response response = _mailHelper.SendMail(model.UserName, "Vehicles - Confirmación de cuenta",
                    ...
                    $"por favor hacer click en el siguiente enlace: </br></br><a href= \"{tokenLink}\">Confirmar Email</a>");
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                ViewBag.Message = "Las instrucciones para el cambio de contraseña han sido enviados a su email.";
                return View();
            }
