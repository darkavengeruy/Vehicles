    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create(UserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //Response response = _mailHelper.SendMail(user.UserName, "Vehicles - Confirmación de Email",
                //    $"<h1>Vehicles - Confirmación de Email</h1>" +
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            // al usuario le actualizamos la foto.
            try
            {
            ...
            catch (DbUpdateException dbUpdateException)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Ya existe un vehicle con esa placa.");
                }
                else
                {
        ...
        public async Task<IActionResult> EditHistory(int id, HistoryViewModel historyViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                history.Mileage = historyViewModel.Milage;
